      ...
      <div className="eventData_Event">
        ...
        <div className="secondaryInfo">
          <div className="eventTimeContainer_Event">
            <p className="eventStartTime_Event">
              Start Time: <Moment format="YYYY/MM/DD - hh:mm">{eventData.startTime}</Moment>
            </p>
            <p className="eventEndTime_Event"> End Time: <Moment format="YYYY/MM/DD - hh:mm">{eventData.endTime}</Moment> </p>
          </div>
