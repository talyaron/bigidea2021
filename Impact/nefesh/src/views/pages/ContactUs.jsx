	...
	return (
		<div className='back-color'>
			...
			<div className='mission'>
				...
				<p>
					The Hub bridges new Olim to the startup, career and community ecosystem of Tel Aviv, serving as
		...
		<div className = "buttonHolder">
			...
			<div className='button' onClick = {openLink}>
				<img src={www} id = "www"/>https://www.nbn.org.il/nbn-tlv-hub/
			</div>
      		<div className='button'>
      			<img src={home} id = 'home' />76 Rothschild BLVD Tel Aviv, Israel
      		</div>
		</div>	
